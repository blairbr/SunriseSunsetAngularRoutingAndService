...
describe('workspace-project App', function () {
    ...
    it('should display welcome message', function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    _a = expect;
                    return [4 /*yield*/, page.getTitleText()];
                case 2:
                    _a.apply(void 0, [_b.sent()]).toEqual('sunriseSunsetExample app is running!');
                    return [2 /*return*/];
            }
        });
    }); });
